;(function ($, window) {
    let ele = null,
        ...
        g = {},//全局变量
        defaults = {
            "navWidth": 80,//列表每个宽度,该版本中请把宽高填写成一样
            "navHeight": 55,//列表每个高度,该版本中请把宽高填写成一样
            "navItemNum": 5,//列表显示个数
    ...
    let methods = {
        init: function (options) {
            ...
            //todo 以后可以分开宽度和高度的限制
            boxWidth = ele.outerWidth();  //在小屏幕中,有 padding 的情况下,计算不准,需要手动指定 ele 的宽度
...
<p class='exzoom_preview'>
    ...
    function bindingEvent() {
        ...
        exzoom_zoom_outer.on("mousemove", function (e) {
            let width_limit = exzoom_zoom.width() / 2,
                ...
                max_X = exzoom_zoom_outer.width()
                // max_Y = exzoom_zoom_outer.height() - width_limit,
                max_Y = exzoom_zoom_outer.height(),
    ...
    function copute_image_prop(image, width, height) {
        ...
        if (img_scale === 1) {
            ...
            res[3] = boxWidth * img_scale;//width
            res[4] = boxHeight;//height
            res[5] = 0;//top
