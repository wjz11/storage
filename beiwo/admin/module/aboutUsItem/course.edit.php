...
if (isset($_GET['id'])) {
    $banner = $db->get('tb_course', '*', array('tbid' => $_GET['id']));
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>倍沃历程管理 - <?php echo getconfig('title'); ?>管理后台</title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <form class="form-horizontal" id="editForm" action="course.ajax.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" name="intro" id="intro" placeholder="请输入简介"
                                          class="form-control"
                                          style="min-height: 100px"><?php echo $banner['intro']; ?></textarea>
                                <span class="help-block m-b-none"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="show_time" readonly class="form-control layer-date"
                                       value="<?php echo date('Y-m-d', $banner['show_time']); ?>" id="hello1">
...
<script>
    $(function () {
        ...
        uploader1 = WebUploader.create({
            ...
            // 文件接收服务端。
            server: 'course.ajax.php?ac=upload1',
            // 选择文件的按钮。可选。
