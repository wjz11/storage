...
<head>
    ...
    <title>倍沃团队 - <?php echo getconfig('title'); ?>管理后台</title>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h2><button type="button" class="btn btn-white btn-sm closelayer pull-right">返回</button>倍沃团队</h2>
        </div>
            ...
            <div class="row row-lg">
                <div class="col-sm-12">
                    ...
                    <table id="table" data-toggle="table"
                           data-url="team.ajax.php?ac=list"
                        ...
                        <tr>
                            ...
                            <th data-field="title" data-halign="center" data-align="center">头衔</th>
                            <th data-field="is_index" data-halign="center" data-align="center">展示</th>
