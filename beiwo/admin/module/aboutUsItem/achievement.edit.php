...
if (isset($_GET['id'])) {
    $banner = $db->get('tb_about_us_certificate', '*', array('tbid' => $_GET['id']));
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>倍沃成就管理 - <?php echo getconfig('title'); ?>管理后台</title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <form class="form-horizontal" id="editForm" action="achievement.ajax.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="time" readonly class="form-control layer-date"
                                       value="<?php echo date('Y-m-d', $banner['time']); ?>" id="hello1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" id="name" placeholder="请填写奖项名称"
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">轮播展示</label>
                            <div class="col-sm-10" style="padding-top:7px;">
                                <div class="onoffswitch">
                                    <input id="is_show" name="is_show" class="onoffswitch-checkbox"
                                           type="checkbox" <?php if ($banner['is_show']) { ?> checked="" <?php } ?>>
                                    <label class="onoffswitch-label" for="is_show">
                                        <span class="onoffswitch-inner"></span>
                                        <span class="onoffswitch-switch"></span>
                                    </label>
                                </div>
...
<script src="<?php echo SITEROOTURL; ?>/admin/js/plugins/layer/laydate/laydate.js"></script>
<script>
    $(function () {
        ...
        uploader1 = WebUploader.create({
            ...
            // 文件接收服务端。
            server: 'achievement.ajax.php?ac=upload1',
            // 选择文件的按钮。可选。
