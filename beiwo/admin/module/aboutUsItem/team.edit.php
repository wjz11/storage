...
if (isset($_GET['id'])) {
    $banner = $db->get('tb_team', '*', array('tbid' => $_GET['id']));
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>倍沃团队管理 - <?php echo getconfig('title'); ?>管理后台</title>
    ...
    <link href="<?php echo SITEROOTURL; ?>/admin/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css"
          rel="stylesheet">
</head>
<body class="gray-bg">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <form class="form-horizontal" id="editForm" action="team.ajax.php">
                            ...
                            <div class="col-sm-10">
                                <div class="radio radio-success">
                                    <input type="radio" id="inlineRadio1" value="1" name="type"
                                           <?php if ($banner['type'] == 1){ ?>checked="" <?php } ?>>
                                    <label for="inlineRadio1"> 研发人员</label>
                                </div>
                                <div class="radio radio-success">
                                    <input type="radio" id="inlineRadio2" value="2" name="type"
                                           <?php if ($banner['type'] == 2){ ?>checked="" <?php } ?>>
                                    <label for="inlineRadio2"> 管理团队</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <p class="form-control-static lookimg">
                                    <?php echo $banner['image'] ? '<img class="img-thumbnail"  style="max-width:220px;max-height:220px;" src="' . SITEROOTURL . $banner['image'] . '"/>' : '【未上传图片】'; ?>
                                </p>
                                ...
                                <div class="alert alert-warning">图片大小不超过2MB，图片尺寸最小比例<span
                                            class="imagewh"> 220 x 220</span></div>
                            </div>
                            <span class="help-block m-b-none"></span>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" id="name" placeholder="请填写姓名"
                                       class="form-control" value="<?php echo $banner['name']; ?>">
                                <span class="help-block m-b-none"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" id="title" placeholder="请填写头衔"
                                       class="form-control" value="<?php echo $banner['title']; ?>">
                                <span class="help-block m-b-none"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" name="intro" id="intro" placeholder="请输入简介"
                                          class="form-control" style="min-height: 100px"><?php echo $banner['intro']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">生平事迹</label>
                            <div class="col-sm-10">
                                <script type="text/plain" id="editor_description" style="height:300px;"><?php echo stripslashes($banner['content']); ?></script>
...
<script>
    $(function () {
        ...
        uploader1 = WebUploader.create({
            ...
            // 文件接收服务端。
            server: 'team.ajax.php?ac=upload1',
            // 选择文件的按钮。可选。
        ...
        uploader1.on('uploadSuccess', function (file, cb) {
            if (cb.state == 'SUCCESS') {
                $('#upload-group1').prev('p').html('<img class="img-thumbnail" style="max-width:220px;max-height:220px;" src=" ' + cb.preview + '"/>');
                $('#image').val(cb.url);
            } else {
                alert(cb.state);
            }
