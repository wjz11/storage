...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h2><button type="button" class="btn btn-white btn-sm closelayer pull-right">返回</button>倍沃历程</h2>
        </div>
            ...
            <div class="row row-lg">
                <div class="col-sm-12">
                    ...
                    <table id="table" data-toggle="table"
                           data-url="course.ajax.php?ac=list"
                        ...
                        <tr>
                            ...
                            <th data-field="intro" data-halign="center" data-align="center">简介</th>
                            <th data-field="show_time" data-halign="center" data-align="center">年月</th>
