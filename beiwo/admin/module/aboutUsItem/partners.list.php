...
<head>
    ...
    <title>合作伙伴 - <?php echo getconfig('title'); ?>管理后台</title>
            ...
            <div class="row row-lg">
                <div class="col-sm-12">
                    ...
                    <table id="table" data-toggle="table"
                           data-url="partners.ajax.php?ac=list"
    ...
    $(function () {
        ...
        $('#table').on('click', '.edit', function (event) {
            ...
            layer.open({
                ...
                shade: false,
                move: false,
                content: 'partners.edit.php?id=' + id
            });
        })
