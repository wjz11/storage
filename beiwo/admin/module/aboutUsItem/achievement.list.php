...
<head>
    ...
    <title>倍沃成就 - <?php echo getconfig('title'); ?>管理后台</title>
            ...
            <div class="row row-lg">
                <div class="col-sm-12">
                    ...
                    <table id="table" data-toggle="table"
                           data-url="achievement.ajax.php?ac=list"
                           ...
                           data-page-list="[10, 20]" data-show-refresh="true"
                           data-toolbar="#toolbar">
                        <thead>
                        <tr>
                            <th data-field="image" data-halign="center" data-align="center">图片</th>
                            <th data-field="time" data-halign="center" data-align="center">获奖年份</th>
                            <th data-field="name" data-halign="center" data-align="center">奖项名称</th>
                            <th data-field="is_index" data-halign="center" data-align="center">首页展示</th>
                            <th data-field="indexid" data-halign="center" data-align="center">排序</th>
                            <th data-field="is_show" data-halign="center" data-align="center">轮播展示</th>
    ...
    $(function () {
        ...
        $('#table').on('click', '.edit', function (event) {
            ...
            layer.open({
                ...
                shade: false,
                move: false,
                content: 'achievement.edit.php?id=' + id
            });
        })
