        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
             ...
             <button type="button" class="btn btn-white btn-sm closelayer pull-right">返回</button>
                <?php
                    echo $db->get('tb_about_us_category', 'name', ['tbid' => $_GET['cid']]);
                ?>分项
            </h3>
            </div>
            <div class="ibox-content">
                <div class="row row-lg">
                    <div class="col-sm-12">
                        ...
                        <table id="table" data-toggle="table" data-url="ajax.php?ac=listItem&cid=<?php echo $_GET['cid'];?>" data-classes="table table-hover table-condensed" data-striped="true" data-pagination="true" data-page-size="20" data-side-pagination="server" data-page-list="[20, 40]" data-search="true" data-show-refresh="true" data-show-toggle="false" data-toolbar="#toolbar">
                            <thead>
                                <tr>
                                    <th data-field="content"  data-halign="center" data-align="center"  >内容</th>
                                     <th data-field="createtime"  data-halign="center" data-align="center"  >发布时间</th>
