...
require '../../../global.php';
//进入页面后先判断是否有访问权限
checkAdminAuthorizeAndJump('services_support.services_edit');
if (isset($_GET['id'])) {
...
<head>
    ...
    <title>合同服务管理 - <?php echo getconfig('title'); ?>管理后台</title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <form class="form-horizontal" id="editForm" action="services.ajax.php">
    ...
    $(function () {
        var closeLayer = function () {
            ...
            try {
                ...
                location.href = 'servers.list.php';
            }
        }
        ...
        var uploader3 = WebUploader.create({
            ...
            // 文件接收服务端。
            server: 'services.ajax.php?ac=uploadFile',
            // 选择文件的按钮。可选。
