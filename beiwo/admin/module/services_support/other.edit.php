...
<head>
    ...
    <title>其他管理 - <?php echo getconfig('title'); ?>管理后台</title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <form class="form-horizontal" id="editForm" action="other.ajax.php">
                        <input type="hidden" name="ac" value="edit">
                        <input type="hidden" name="id" value="<?php echo $banner['url_type']; ?>">
                        ...
                        <div class="form-group zy">
                            ...
                            <div class="col-sm-10">
                                <p class="form-control-static">
                                    <?php
                                    echo $banner['file'] ?
                                            '<a href="' . SITEROOTURL . $banner['file'] . '" class="btn btn-primary btn-xs" style="position:relative" target="ddd">资料</a>' :'【未上传文件】';
                                    ?>
                                </p>
                                <div class="btn-group" id="upload-group2_1">
                                    ...
                                    if(!empty($banner['file'])){
                                        echo '<a class=" btn-info btn-xs" style="margin-left:20px;height:20px" href="' . SITEROOTURL . $banner["file"].'" download="'.$banner['title'].'">下载资料
                                            </a>';
                                    }
                                    ?>
                            ...
                            <div class="col-sm-10" style="padding-top:7px;">
                                <div class="onoffswitch">
                                    <input id="is_use" name="is_use" class="onoffswitch-checkbox"
                                           type="checkbox" <?php if ($banner['is_use']) { ?> checked="" <?php } ?>>
...
<script>
    $(function () {
        ...
        var uploader3 = WebUploader.create({
            ...
            // 文件接收服务端。
            server: 'other.ajax.php?ac=uploadFile',
            // 选择文件的按钮。可选。
