...
require '../../../global.php';
//进入页面后先判断是否有访问权限
checkAdminAuthorizeAndJump('services_support.services_browse');
?>
<!DOCTYPE html>
<html>
<head>
...
<input type="hidden" id="authorize-edit"
       value="<?php echo checkAdminAuthorize('services_support.services_edit') ? 1 : 0; ?>">
            ...
            <div class="row row-lg">
                <div class="col-sm-12">
                    ...
                    <table id="table" data-toggle="table"
                           data-url="services.ajax.php?ac=list"
                        ...
                        <tr>
                            ...
                            <th data-field="edittime" data-sortable="true" data-halign="center" data-align="center"
                                data-width="150">编辑时间
                            </th>
    ...
    $(function () {
        ...
        $('#table').on('click', '.edit', function (event) {
            ...
            layer.open({
                ...
                shade: false,
                move: false,
                content: 'services.edit.php?id=' + id
            });
        })
