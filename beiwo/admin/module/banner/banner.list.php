...
require '../../../global.php';
//进入页面后先判断是否有访问权限
checkAdminAuthorizeAndJump('banner.image_browse');
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body class="gray-bg">
        ...
        <input type="hidden" id="authorize-edit" value="<?php echo checkAdminAuthorize('banner.image_edit') ? 1 : 0; ?>">
                    ...
                    <div class="row row-lg">
                        <div class="col-sm-12">
                            ...
                            <table id="table" data-toggle="table"
                                   data-url="banner.ajax.php?ac=list&banner_category_id=<?php echo $_GET['banner_category_id']; ?>"
                                ...
                                <thead>
                                    <tr>
                                        <th data-field="image" data-halign="center" data-align="center" data-width="100">展示图</th>
                                        <th data-field="name" data-halign="center" data-align="center" data-width="100">名称</th>
                                        <th data-field="createtime" data-sortable="true" data-halign="center" data-align="center" data-width="150">发布时间</th>
                                        <th data-field="edittime" data-sortable="true" data-halign="center" data-align="center" data-width="150">编辑时间</th>
                                        <th data-field="admin_member_id" data-sortable="true" data-halign="center" data-align="center" data-width="150">最后编辑人</th>
            ...
            $(function () {
                ...
                $('#table').on('click', '.edit', function (event) {
                    ...
                    layer.open({
                        ...
                        shade: false,
                        move: false,
                        content: 'banner.edit.php?id=' + id + '&banner_category_id=<?php echo $_GET['banner_category_id']; ?>'
                    });
                })
                ...
                $('#add').click(function (event) {
                    ...
                    layer.open({
                        ...
                        shade: false,
                        move: false,
                        content: 'banner.edit.php?banner_category_id=<?php echo $_GET['banner_category_id']; ?>'
                    });
                });
