...
require('../../../global.php');
//进入页面后先判断是否有访问权限
inc\Authorize::checkAdminAuthorizeAndJump('commonProblem.browse');
            ...
            <div class="ibox-content">
                <div class="row row-lg">
                    <div class="col-sm-12">
                        ...
                        <?php 
                            if (inc\Authorize::checkAdminAuthorize('commonProblem.edit')) {
                        ?>
                        ...
                        <table id="table" data-toggle="table" data-url="ajax.php?ac=listTable" data-classes="table table-hover table-condensed" data-striped="true" data-pagination="true" data-side-pagination="server" data-page-list="[10, 20]" data-search="true" data-show-refresh="true" data-show-toggle="false" data-toolbar="#toolbar">
                            <thead>
                                <tr>
                                    <th data-field="indexid" data-halign="center" data-align="center" data-sortable="true">排序</th>
                                    <th data-field="problem" data-halign="center" data-align="center" data-sortable="true">问题</th>
