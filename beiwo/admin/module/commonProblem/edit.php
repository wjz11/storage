<?php
require('../../../global.php');
inc\Authorize::checkAdminAuthorizeAndJump('commonProblem.edit');
if(isset($_GET['id'])){
    $row = $db->get('tb_common_problem', '*', array('tbid' => $_GET['id']));
                    ...
                    <div class="col-sm-12">
                        <form class="form-horizontal" id="editForm" action="ajax.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" name="problem" id="problem" placeholder="请输入问题" class="form-control" style="min-height: 100px" dataType="*" nullmsg="请输入问题" errormsg="请输入问题" ><?php echo $row['problem']; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" name="answer" id="answer" placeholder="请输入回答" class="form-control" style="min-height: 100px" dataType="*" nullmsg="请输入回答" errormsg="请输入回答" ><?php echo $row['answer']; ?></textarea>
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">排序(整数且越小越靠前)</label>
                                <div class="col-sm-8">
                                    <input type="text" name="indexid" dataType="n" id="indexid" placeholder="请输入整数排序值(越小越靠前,1最靠前)"
                                           class="form-control" value="<?php echo $row['indexid']; ?>">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
