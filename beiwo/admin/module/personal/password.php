...
<head>
    ...
    <title>修改密码 - <?php echo getconfig('title'); ?>管理后台</title>
</head>
<body class="gray-bg">
                    ...
                    <div class="col-sm-12">
                        <form class="form-horizontal" id="editForm" action="ajax.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="oldpassword" id="oldpassword" placeholder="请输入原密码" class="form-control" dataType="*" ajaxurl="ajax.php?ac=checkPassword" nullmsg="请输入原密码" errormsg="请输入原密码">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password" id="password" placeholder="请输入新密码" class="form-control" dataType="*6-16" nullmsg="请输入新密码" errormsg="密码范围在6~16位之间">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="confirm_password" id="confirm_password" placeholder="请输入新密码" class="form-control" dataType="*6-16" recheck="password" nullmsg="请输入新密码" errormsg="您两次输入的账号密码不一致">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button class="btn btn-primary" type="submit" id="btn-submit">确定</button>
                                </div>
                            </div>
                        </form>
                    </div>
