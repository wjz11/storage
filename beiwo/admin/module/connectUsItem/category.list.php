...
<head>
    ...
    <title>营销网络信息管理 - <?php echo getconfig('title'); ?>管理后台</title>
...
<body class="gray-bg">
    ...
    <input type="hidden" id="authorize-edit" value="<?php echo inc\authorize::checkAdminAuthorize('connectUs.edit') ? 1 : 0; ?>">
...
<!--                          -->
<!--                        </div>-->
                        <table id="table" data-toggle="table" data-url="ajax.php?ac=listCategory" data-classes="table table-hover table-condensed" data-striped="true" data-pagination="true" data-page-size="20" data-side-pagination="server" data-page-list="[20, 40]" data-search="true" data-show-refresh="true" data-show-toggle="false" data-toolbar="#toolbar">
                            <thead>
                                <tr>
                                    <th data-field="name"  data-halign="center" data-align="center"  >名称</th>
                                    <th data-field="num"  data-halign="center" data-align="center"  >网点数量</th>
                                    <th data-field="do" data-halign="center" data-align="center" data-width="350">操作</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
    ...
    $(function(){
        ...
        .on('click', '.edit', function(event){
            ...
            layer.open({
                ...
                shade: false,
                move: false,
                content: 'category.edit.php?id='+id
            });
