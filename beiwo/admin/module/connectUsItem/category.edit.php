...
if (!empty($_GET['id'])) {
    $row = $db->get('tb_connect_us_category', '*', ['tbid' => $_GET['id']]);
}
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-sm-12">
                        <form class="form-horizontal" id="editForm" action="ajax.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="english_name" id="english_name" placeholder="请输入英文名" class="form-control" value="<?php echo $row['english_name']; ?>" dataType="*" nullmsg="请输入英文名" errormsg="请输入英文名">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="indexid" id="indexid" placeholder="请输入排序" class="form-control" value="<?php echo $row['indexid']; ?>" dataType="n" nullmsg="请输入排序" errormsg="请输入排序">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
