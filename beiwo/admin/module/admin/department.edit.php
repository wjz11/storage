...
if(isset($_GET['id'])){
    $category = $db->get('tb_admin_department', '*', array('tbid' => $_GET['id']));
}
?>
<!DOCTYPE html>
<html>
                ...
                <div class="row row-lg">
                    <div class="col-sm-12">
                        <form class="form-horizontal" id="editForm" action="department.ajax.php">
                            <input type="hidden" name="ac" value="editDepartment">
                            <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">名称</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" id="name" placeholder="请输入名称" class="form-control" value="<?php echo $category['name']; ?>" dataType="*" nullmsg="请输入名称" errormsg="请输入名称">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="main" id="main" placeholder="请输入部门主管" class="form-control" value="<?php echo $category['main']; ?>" dataType="*" nullmsg="请输入部门主管" errormsg="请输入部门主管">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">主管手机</label>
                                <div class="col-sm-10">
                                    <input type="text" name="mobile" id="mobile" placeholder="请输入主管手机" class="form-control" value="<?php echo $category['mobile']; ?>" dataType="/^[1][0-9]{10}$/" nullmsg="请输入主管手机" errormsg="请输入主管手机">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">工位座机</label>
                                <div class="col-sm-10">
                                    <input type="text" name="special" id="special" placeholder="请输入工位座机" class="form-control" value="<?php echo $category['special']; ?>" >
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control val-note" id="intro" name="intro" rows="5" style="resize:none" placeholder="简介" ignore="ignore" dataType="*1-250" nullmsg="请输入简介" errormsg="最多250个字"><?php echo $category['intro'];?></textarea>
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
