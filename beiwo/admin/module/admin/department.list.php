...
<body class="gray-bg">
    ...
    <input type="hidden" id="authorize-edit" value="<?php echo Authorize::checkAdminAuthorize('admin.edit') ? 1 : 0; ?>">
            ...
            <div class="ibox-content">
                <div class="row row-lg">
                    <div class="col-sm-12">
                        ...
                        <table id="table" data-toggle="table" data-url="department.ajax.php?ac=listDepartment" data-classes="table table-hover table-condensed" data-striped="true" data-pagination="true" data-page-size="20" data-side-pagination="server" data-page-list="[20, 40]" data-search="true" data-show-refresh="true" data-show-toggle="false" data-toolbar="#toolbar">
                            <thead>
                                <tr>
                                    <th data-field="name" data-align="center">名称</th>
                                    <th data-field="count" data-align="center">成员人数</th>
                                    <th data-field="main" data-align="center">部门主管</th>
    ...
    $(function(){
        ...
        $('#table').on('click', '.position', function(event){
            ...
            layer.open({
                ...
                shade: false,
                move: false,
                content: 'department.index.php?id='+id
            });
        })
        .on('click', '.edit', function(event){
            ...
            layer.open({
                ...
                shade: false,
                move: false,
                content: 'department.edit.php?id='+id
            });
        })
