...
require('../../../global.php');
//进入页面后先判断是否有访问权限 
inc\Authorize::checkAdminAuthorizeAndJump('precaution.browse');
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="gray-bg">
    ...
    <input type="hidden" id="authorize-edit" value="<?php echo inc\authorize::checkAdminAuthorize('precaution.edit') ? 1 : 0; ?>">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
             ...
             <button type="button" class="btn btn-white btn-sm closelayer">返回</button>
                <?php
                    echo $db->get('tb_precaution_category', 'name', ['tbid' => $_GET['cid']]);
                ?>分项管理
            </h3>
            </div>
                ...
                <div class="row row-lg">
                    <div class="col-sm-12">
                        ...
                        <table id="table" data-toggle="table" data-url="ajax.php?ac=listItem&cid=<?php echo $_GET['cid'];?>" data-classes="table table-hover table-condensed" data-striped="true" data-pagination="true" data-page-size="20" data-side-pagination="server" data-page-list="[20, 40]" data-search="true" data-show-refresh="true" data-show-toggle="false" data-toolbar="#toolbar">
                            <thead>
                                <tr>
                                    <th data-field="precaution"  data-halign="center" data-align="center"  >注意事项</th>
